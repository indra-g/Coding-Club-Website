...
function ViewIndividualContributedScripts(props) {
    ...
    useEffect(() => {
        Axios.get(`/api/contribute-scripts/${props.match.params.id}`)
            .then((script) => {
    ...
    return (
        <div className="content-wrapper">
            ...
            <div><a href={'/contributed-scripts-home'} className={'back-to-home'}> &lt; Back to Home</a></div>
        </div>
    );
}

export default ViewIndividualContributedScripts;
