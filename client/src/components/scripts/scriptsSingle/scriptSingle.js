...
function ItemDetail({ props }) {
    ...
    return (
        <div className="row">
            <div>
                <div className="card border-secondary" style={{margin: "10px", borderRadius: "10px"}}>
                    <div className="card-header">
                        <div className="row">
                            <div className="col-sm-1">
                                <img src={logo} alt="can't fetch" style={{ height : "50px" , width : "90px" }}/>
                            </div>
                            <div className="col-sm-4">
                                <h3><b>PSG TECH CODING CLUB</b></h3>
                            </div>
