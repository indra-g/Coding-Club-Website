...
import ContributedScriptsSlider from "./contributedScriptsSlider"

function ContributedScriptsScreen() {
                        ...
                        <div className="container-fluid">
                            ...
                            >
                                <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                                    ...
                                    <li className="nav-item"><a className="nav-link active align-middle" aria-current="page" href="/scripts">Scripts</a></li>
...
export default ContributedScriptsScreen;
